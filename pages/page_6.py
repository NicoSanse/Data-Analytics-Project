...
def plot_bar(measure):
    full_saga_df = pd.read_csv(
        "/Users/nicosanse/Desktop/Uni/1' sem/Lab/Data Analytics/Data Analytics Project/outputs/full_saga_with_emotions.csv",
        encoding="utf-8-sig",
    )
    ...
    nrc_emotions = pd.read_csv(
        "/Users/nicosanse/Desktop/Uni/1' sem/Lab/Data Analytics/Data Analytics Project/outputs/nrc_emotions.csv",
        encoding="utf-8-sig",
    )
...
layout = html.Div(
    [
        html.H1("Parte 3"),
        html.H2("Emozioni dominanti e casata di appartenenza"),
        html.P(
